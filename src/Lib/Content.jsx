...
export default {
    languagesFrameworksTools: ["JavaScript", "TypeScript", "Python", "PHP", "Dart", "ReactJS", "NextJS", "NodeJS", "Flutter", ".NET", "jQuery", "GitHub", "HubSpot", "WordPress", "Firebase", "Agora", "Banuba", "GetStream", "Dyte", "Speech to Text API", "BurpSuite", "Cypress"],
    projectManagement: ["Jira", "Asana", "Miro", "Figma", "Postman", "Slack", "Trello", "ClickUp", "Zeplin", "Google Play Developer", "App Store Connect", "Zendesk"],
    marketing: ["Google Ads", "Google Search Console", "Google Analytics", "Google Trends", "SEM Rush", "HubSpot", "Google Data Studio"],
    devOpsCloud: ["DNS Management", "CI/CD", "Kubernetes", "Docker", "Nginx", "AWS", "Google Cloud", "Heroku", "Azure", "Azure DevOps", "Vercel", "Netlify", "Cloudflare"],
    education: {
        ug: {
    ...
    work: [
        {
            ...
            role: "Operations and Engineering Manager",
            description: ["· I was promoted to the role of Engineering Manager for Trademarkia in December 2022.", "· I worked as a bridge between the tech, product, design, marketing, legal, finance, PPC and customer service teams and helped re-architect the processes followed to reduce miscommunication and increase the cycle time of processing orders. ", "· I understood the requirements and issues faced by internal teams & clients and conveyed them to the product designers. I then reviewed their suggested UX optimisations and provided feedback which I then assigned to developers to work upon. Once the feature or optimisation was developed, I gave a knowledge transfer to the QA team, who tested it to ensure there were no new bugs.", "· In this role, I wasn't responsible for just having the desired product requirements executed, but I also ensured the team leads globally (Nagpur, South Africa, United States, European Union, United Kingdom, Argentina, Mexico, and Japan) were always in the loop and knew how to train their teams on our updated software through release logs and follow up Google Meet video calls.", "· In parallel, we launched over 8 projects for our sub-brands under my guidance as I was able to delegate and prioritise work for developers & designers in sprints which helped them be productive.", "· Being the primary POC for all teams, I was able to learn about other domains in addition to enhancing my engineering and management skills."],
        ...
        },
        {
            ...
            description: ["· Working as an all-rounded manager for four ventures under the firm- Trademarkia, Enforceable, Atherton, and Nearcast, I was able to balance both corporate and startup work styles as Trademarkia is an established company running for more than 12 years whereas Enforceable, Atherton, and Nearcast are startups we had to bring up from scratch.", "· I helped Trademarkia create their own in-house engineering teams as the tech team was outsourced before. This included understanding business logic, the tech stack used, hiring a team to maintain legacy code, and relaying the same to new developers who parallelly revamped the applications into modern tech stacks.", "· I led Nearcast's marketing, design, tech, and product teams to brainstorm, design, develop, and publicise the business. Understood the vision from stakeholders, converted it to a functional specifications document, set up sprints which the team could work towards, monitored progress, and planned marketing & email timelines. I was responsible for making the product, a business.", "· I helped set up the engineering office in Chennai and handled the finances and operations for the Indian entity.", "· Whenever there was a deadline, I did not hesitate to code and help the dev team. I worked on release management, deployments, and code reviews to ensure our code was documented and up to production standards."],
            duration: "Jul 15, 2021 - December 2022",
            feedback: "",
        },
        {
            company: "Agora",
        ...
        },
        {
            ...
            description: ["· I recruited over 10 junior interns and led an entire engineering team working on multiple projects as an acting Technical Manager cum Software Developer.", "· I worked on the branding, designing, development, and SEO of multiple websites developed by Josh Talks including but not limited to DigitalBeti, GOAL, Josh Recruitment Tests, and Josh Skills. ", "I maintained legacy projects written in Django, NodeJS, and React while also setting up the DevOps with CI/CD.", "· I also mentored a team of interns who revamped the main Josh Talks website. ", "· I realised I liked project management and decided to pivot towards the role and explore new domains slowly."],
